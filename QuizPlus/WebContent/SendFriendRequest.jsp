...
<form action="MessageSendingServlet" method="post">
	...
	%>/><br> <br>
	<b>Message:</b><br />
	<textarea cols="45" rows="9" name="message" >Hi, I would like to add you to my network</textarea>	
	<input type="hidden" name="messageType" value="1"/>
	<br> <br><input type="submit" value="Send Request" />
